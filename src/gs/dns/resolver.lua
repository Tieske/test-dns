...
-- format a binary string for nice output
local function binary_string(str, title)
  if type(str) ~= "string" then return nil end
  local result = (title or "Binary string") .. " (" .. tostring(#str) .. " bytes)\n"
  local i = 1
  local hex = ""
  local chr = ""
  while i <= #str do
...
print(binary_string(old_buf .. buf, "TCP answer: "))
...
print(binary_string(table.concat(query), "Query: "))
    ...
    for i = 1, retrans do
        ...
        for j = 1, 128 do
            ...
            if buf then
print(binary_string(buf, "UDP answer: "))
                local answers
